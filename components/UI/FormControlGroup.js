...
export const ControlGroup = ({type, placeholder, id, className, name, labelActive, onChange, value}) => {
//   const [controlData, configureControlData] = useState("");
  ...
  return(
    <div className="control-group">
      ...
      <input type={type} name={name} value={value} onChange={event => onChange(event)} className={`login-field ${className !== undefined ? className :""}`} placeholder={placeholder} id={id} required/>
